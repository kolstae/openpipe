 ...
 * reference-equality in place of object-equality when comparing objects.
 * <p/>
 * In other words, in an <tt>IdentityHashSet</tt>, two objects
 * <tt>k1</tt> and <tt>k2</tt> are considered equal if and only if
 * <tt>(k1==k2)</tt>.  (In normal <tt>Set</tt> implementations (like
 * <tt>HashSet</tt>) two objects <tt>k1</tt> and <tt>k2</tt> are considered equal

 ...
 * @version $Revision$
 */
public class Base64OutputBufferTest extends TestCase {
   ...
   public void testWrite() throws Exception {
      final Base64OutputBuffer out = new Base64OutputBuffer();
      test(out, TEXT1, RES1, true);
      test(out, TEXT2, RES2, false);
      test(out, TEXT3, RES3, false);
      test(out, TEXT4, RES4, true);
   }

   private static void test(Base64OutputBuffer out, String text, String result, boolean writeAllBytes) 
         throws IOException {
      if (writeAllBytes) {

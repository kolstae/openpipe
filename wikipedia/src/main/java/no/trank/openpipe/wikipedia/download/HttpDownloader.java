...
public class HttpDownloader {
   ...
   private DownloadProgressListener progressListener = new NullProgressListener();
   ...
   public void setProgressListener(DownloadProgressListener progressListener) {
      this.progressListener = progressListener == null ? new NullProgressListener() : progressListener;
   }
